...
def construct_input(
    ...
    if num_fewshot == 0:
        ...
        fewshotex = fewshot_examples(
            k=num_fewshot + 1, rnd=rnd, dataset=dataset
        )
        ...
        for d in fewshotex:
            data = trans_func(
                d, num_fewshot, rnd, dataset_name
            )
...
def main():
    ...
    prompt_input = [
        construct_input(item.data, num_fewshot, rnd, trans_func, dataset, dataset_name, description)
