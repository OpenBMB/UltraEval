...
def transform_entry(data_entry):
    return {
        "passage": data_entry["passage"]["text"],
        "question": data_entry["qas"][0]["query"],
        "target_scores": {},
        "answer": [answer["text"] for answer in data_entry["qas"][0]["answers"]],
    }
...
def main():
    ...
    input_path = "../../RawData/record/val.jsonl"
    output_path = "./data/record.jsonl"
