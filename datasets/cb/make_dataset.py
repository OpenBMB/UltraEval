...
def transform_entry(data_entry):
    return {
        ...
        "question": "",
        "target_scores": {
            "Contradiction": int(data_entry["label"] == "contradiction"),
            "Entailment": int(data_entry["label"] == "entailment"),
            "Neutral": int(data_entry["label"] == "neutral"),
        },
        "answer": "",
    }
...
def main():
    ...
    input_path = "../../RawData/cb/val.jsonl"
    output_path = "./data/cb.jsonl"
