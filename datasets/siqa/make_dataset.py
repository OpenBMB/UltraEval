...
def transform_entry(data_entry, label):
    options = [data_entry["answerA"], data_entry["answerB"], data_entry["answerC"]]
...
def main():
    ...
    jsonl_path = "../../RawData/siqa/dev.jsonl"
    lst_path = "../../RawData/siqa/dev-labels.lst"
    output_path = "./data/siqa.jsonl"
